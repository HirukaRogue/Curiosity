...
public class ResearchComponentContainer implements Container, StackedContentsCompatible {
    private final int size;
    private final NonNullList<ItemStack> items;
    @Nullable
    private List<ContainerListener> listeners;

    public ResearchComponentContainer(int pSize) {
        this.size = pSize;
        this.items = NonNullList.withSize(pSize, ItemStack.EMPTY);
    }

    public ResearchComponentContainer(ItemStack... pItems) {
    ...
    public String toString() {
        return this.items.stream().toList().toString();
    }
